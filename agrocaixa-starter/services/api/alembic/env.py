...
def _load_dotenv_if_present() -> None:
    """Load agrocaixa-starter/.env for local alembic runs.

    docker-compose already injects env vars; this is mainly for running
    `alembic` on the host machine.
    """
    ...
    # Look for a .env file in parent directories (works both on host and in Docker)
